export { OddmiscIntegrationOptions, UmamiIntegrationOptions, oddmisc, umami } from './astro/index.js';
import 'astro';
...
declare class UmamiUrlError extends UmamiError {
    constructor(message: string);
}
declare class UmamiAuthError extends UmamiError {
    constructor(message: string, status?: number);
}
declare class UmamiNetworkError extends UmamiError {
    constructor(message: string, status?: number);
}
declare class UmamiTimeoutError extends UmamiError {
    constructor(message?: string);
}
...
type MetricType = 'path' | 'referrer' | 'browser' | 'os' | 'device' | 'country' | 'region' | 'city' | 'event' | 'title' | 'language' | 'screen' | 'tag';
...
declare class CacheManager<T = unknown> {
    private memoryCache;
    private readonly cacheKey;
    private readonly ttl;
    private readonly maxEntries;
    private storageCache;
    constructor(namespace?: string, ttl?: number, maxEntries?: number);
    private loadStorage;
    private saveStorage;
    private isExpired;
...
interface PageviewsParams extends TimeRange {
    unit?: 'year' | 'month' | 'day' | 'hour' | 'minute';
    timezone?: string;
}
interface MetricsParams extends TimeRange {
    limit?: number;
}
...
declare class UmamiClient {
    ...
    getPageviews(options?: PageviewsParams): Promise<PageviewsSeries>;
